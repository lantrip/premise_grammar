...
extern "C" {
    fn tree_sitter_premise() -> Language;
}
...
impl Parser {
    pub fn new() -> Self {
        ...
        unsafe {
            parser
                .set_language(&tree_sitter_premise())
                .expect("failed to set Premise language");
        }
    ...
    pub fn parse_str(
        &mut self,
        input: &str,
    ) -> (cst::Cst, Vec<diagnostics::Diagnostic>, Option<ast::AstNode>) {
        ...
        match tree {
            ...
            None => (
                cst::Cst {
                    root_sexpr: String::new(),
                    range: ast::Range::default(),
                },
                vec![diagnostics::Diagnostic::error("Parse failed")],
                None,
            ),
        }
    }
    ...
    pub fn analyze_symbols(&mut self, input: &str) -> crate::symbols::Analysis {
        ...
        match tree {
            ...
            None => crate::symbols::Analysis {
                symbols: crate::symbols::SymbolTable::default(),
                diagnostics: vec![diagnostics::Diagnostic::error("Parse failed")],
            },
        }
    }
    ...
    pub fn analyze_imports(&mut self, input: &str) -> crate::imports::ImportAnalysis {
        ...
        match tree {
            ...
            None => crate::imports::ImportAnalysis {
                imports: crate::imports::ImportList::default(),
                diagnostics: vec![diagnostics::Diagnostic::error("Parse failed")],
            },
        }
    }

    pub fn resolve_imports_with_base<P: AsRef<Path>>(
        &mut self,
        input: &str,
        base_dir: P,
    ...
    pub fn resolve_imports_from_path<P: AsRef<Path>>(
        &mut self,
        path: P,
    ) -> crate::imports::ImportResolution {
        let content = match fs::read_to_string(&path) {
            Ok(c) => c,
            Err(err) => {
                return crate::imports::ImportResolution {
                    resolved: Vec::new(),
    ...
    pub fn validate(&mut self, input: &str) -> crate::validation::ValidationReport {
        ...
        match tree {
            ...
            None => crate::validation::ValidationReport {
                issues: vec![crate::validation::Issue {
                    code: crate::validation::IssueCode::UnknownEntityReference,
